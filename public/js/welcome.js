...
/* harmony import */ var vue_template_compiler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-template-compiler */ "./node_modules/vue-template-compiler/browser.js");
/* harmony import */ var vue_template_compiler__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vue_template_compiler__WEBPACK_IMPORTED_MODULE_1__);


var applicationJSON = 'application/json; charset=utf8';
var applicationEncode = 'application/x-www-form-urlencoded';
var baseURL = 'https://widcqzoxhb.execute-api.us-east-2.amazonaws.com/Prod/api/';
var api = {
  // login  - - - - - - - - - - - - - - - - - - - - -
  ...
  // Recovery Password  - - - - - - - - - - - - - - - - - - - - -
  passwordRecovery: function passwordRecovery(data, callback) {
    $.ajax({
      method: 'POST',
  ...
  if ($("#login-form")) {
    $("#login-form").validate({
      ...
      submitHandler: function submitHandler(form, event) {
        ...
        _Api_api__WEBPACK_IMPORTED_MODULE_0__["default"].login(data, function (data) {
  ...
  if ($("#recovery-form")) {
    $("#recovery-form").validate({
      ...
      submitHandler: function submitHandler(form, event) {
        ...
        _Api_api__WEBPACK_IMPORTED_MODULE_0__["default"].passwordRecovery(data, function (data) {
          console.log(data);
        });
      }
    });
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\herramental\resources\js\welcome.js */"./resources/js/welcome.js");
